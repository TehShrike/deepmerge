...
test('should allow sources to be null or undefined', function (t) {
	var target1 = {}
	var src1 = undefined
	var src2 = null
	var target2 = { value: 2 }
	...
	var expected1 = {}
	var actual1 = merge(target1, src1)
	t.deepEqual(actual1, expected1)

	var actual2 = merge(target1, src2)
	t.deepEqual(actual2, expected1)

	var expected2 = { value: 2 }
	var actual3 = merge(target2, src1)
	t.deepEqual(actual3, expected2)

	var actual4 = merge(target2, src2)
	t.deepEqual(actual4, expected2)
	t.end()
})
